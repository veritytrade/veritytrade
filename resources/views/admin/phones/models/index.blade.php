        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 md:p-6 mb-6">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    <a href="{{ route('admin.phones.models.create', $brand) }}" class="inline-flex items-center justify-center min-h-[44px] bg-green-600 hover:bg-green-700 text-white px-6 py-2.5 rounded-lg font-medium whitespace-nowrap">+ Add Model</a>
                </div>
            </div>
        </div>
