        ...
        <div class="sticky top-16 z-20 bg-white/90 backdrop-blur border-b border-slate-200/70 shadow-sm">
            <div class="overflow-x-auto scrollbar-hide">
                <div class="flex min-w-max px-4">
                    ...
                    <a href="#laptops" class="block flex-shrink-0 px-5 py-4 text-sm font-medium text-gray-600 hover:text-sky-600 whitespace-nowrap transition-colors">
                        Laptops
                    </a>
                    <a href="#tablets" class="block flex-shrink-0 px-5 py-4 text-sm font-medium text-gray-600 hover:text-sky-600 whitespace-nowrap transition-colors">
                        Tablets
                    </a>
                    <a href="#consoles" class="block flex-shrink-0 px-5 py-4 text-sm font-medium text-gray-600 hover:text-sky-600 whitespace-nowrap transition-colors">
                        Consoles
                    </a>
                </div>
            </div>
